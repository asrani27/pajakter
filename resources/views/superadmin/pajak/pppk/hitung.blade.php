        ...
        <div class="card">
            <div class="card-body table-responsive">
                <div class="text-center" style="font-size: 20px">
                    ...
                    <strong>PAJAK PPPK<br />
                        PERIODE : KINERJA {{strtoupper($bulanTahun->bulan)}} {{$bulanTahun->tahun}},
                    </strong>
                </div>
                <form method="post" action="/superadmin/pajakter/pppk/{{$id}}" enctype="multipart/form-data">
                    @csrf
                    <input type="file" name="file" required>
                    <button type="submit" class="btn btn-sm btn-info">
                        <i class="fa fa-upload"></i> UPLOAD GAJI ASN</button>

                    <a href="/superadmin/pajakter/pppk/{{$id}}/reset" class="btn btn-sm btn-danger"
