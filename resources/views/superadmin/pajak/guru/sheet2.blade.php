        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <form method="post" action="/admin/pajakter/{{$id}}/skpd/{{$skpd_id}}/guru"
                    ...
                    <a href="/admin/pajakter/{{$id}}/skpd/{{$skpd_id}}/gurusd/reset" class="btn btn-sm btn-danger"
                        onclick="return confirm('Yakin Di Hapus?');">
                        <i class="fa fa-times"></i> CLEAR DATA</a>
                    <a href="/admin/pajakter/{{$id}}/exportpajak/{{$skpd_id}}/sheet/2" class="btn btn-sm btn-primary">
                ...
                <form method="post" action="/superadmin/pajakter/{{$id}}/skpd/{{$skpd_id}}/guru"
                    ...
                    <button type="submit" class="btn btn-sm btn-info" name="button" value="sheet2">
                        ...
                        <a href="/admin/pajakter/{{$id}}/skpd/{{$skpd_id}}/gurusd/reset" class="btn btn-sm btn-danger"
                            onclick="return confirm('Yakin Di Hapus?');">
                            <i class="fa fa-times"></i> CLEAR DATA</a>
                        <a href="/admin/pajakter/{{$id}}/exportpajak/{{$skpd_id}}/sheet/2"
