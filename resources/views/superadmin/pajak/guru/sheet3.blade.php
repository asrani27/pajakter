        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <form method="post" action="/superadmin/pajakter/{{$id}}/skpd/{{$skpd_id}}/guru"
                    ...
                    <a href="/admin/pajakter/{{$id}}/exportpajak/{{$skpd_id}}/sheet/3" class="btn btn-sm btn-primary">
                    ...
                    <a href="/superadmin/pajakter/{{$id}}/skpd/{{$skpd_id}}/gurusmp/reset" class="btn btn-sm btn-danger"
                        onclick="return confirm('Yakin Di Hapus?');">
                        <i class="fa fa-times"></i> CLEAR DATA</a>
                    <a href="/superadmin/pajakter/{{$id}}/exportpajak/{{$skpd_id}}/sheet/3"
