        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <form method="post" action="/admin/pajakter/{{$id}}/skpd/{{$skpd_id}}/guru"
                    ...
                    <button type="submit" class="btn btn-sm btn-info" name="button" value="sheet1">
                        <i class="fa fa-upload"></i> UPLOAD GAJI</button>

                    <a href="/admin/pajakter/{{$id}}/skpd/{{$skpd_id}}/guru/reset" class="btn btn-sm btn-danger"
                        onclick="return confirm('Yakin Di Hapus?');">
                        <i class="fa fa-times"></i> CLEAR DATA</a>
                    <a href="/admin/pajakter/{{$id}}/exportpajak/{{$skpd_id}}/sheet/1" class="btn btn-sm btn-primary">
                ...
                <form method="post" action="/superadmin/pajakter/{{$id}}/skpd/{{$skpd_id}}/guru"
                    ...
                    <button type="submit" class="btn btn-sm btn-info" name="button" value="sheet1">
                        ...
                        <a href="/admin/pajakter/{{$id}}/skpd/{{$skpd_id}}/guru/reset" class="btn btn-sm btn-danger"
                            onclick="return confirm('Yakin Di Hapus?');">
                            <i class="fa fa-times"></i> CLEAR DATA</a>
                        <a href="/admin/pajakter/{{$id}}/exportpajak/{{$skpd_id}}/sheet/1"
                            class="btn btn-sm btn-primary">
                            <i class="fa fa-file-excel"></i> Export Pajak</a>I</button>
